"""Pure geodetic / topocentric transforms (numpy + pyproj only).

Shared by the photogrammetry stages (mask_images,
sparse_reconstruction_to_dense_point_cloud, create_texture) so they can use
transform_extent_to_local without importing the heavy open3d stack.
"""
import numpy as np
import pyproj
