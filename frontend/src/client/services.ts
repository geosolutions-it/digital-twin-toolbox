...
export class PhotogrammeteryResultService {
  /**
   ...
   * @throws ApiError
   */
  public static getResconstruction(
    id: string,
  ): CancelablePromise<PipelinePublicExtended> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/v1/output/{id}/process/reconstruction.ply",
      path: {
        id,
      },
      errors: {
  ...
  public static getPointcloud(
    id: string,
  ): CancelablePromise<PipelinePublicExtended> {
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/v1/output/{id}/process/undistorted/depthmaps/merged_preview.ply",
      path: {
        id,
      },
      errors: {
  ...
  public static getModel(
    ...
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/v1/output/{id}/process/preview/0_0_0.glb",
      path: {
        id,
      },
      errors: {
